...
OPENAI_API_KEY_TARGET = "ArkClaw/OpenAI/APIKey"
DEEPSEEK_API_KEY_TARGET = (
    f"ArkClaw/Credentials/{DEEPSEEK_DEFAULT_CREDENTIAL_ID.value}"
)
...
class CredentialTargetResolver:
    ...
    def resolve(cls, credential_id: CredentialId) -> str:
        ...
        return f"ArkClaw/Credentials/{credential_id.value}"
