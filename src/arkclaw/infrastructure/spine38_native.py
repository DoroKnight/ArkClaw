...
class _ArkClawSpine38Bounds(ctypes.Structure):
    _fields_ = [
        ("x", ctypes.c_float),
        ("y", ctypes.c_float),
...
class _ArkClawSpine38RootTransform(ctypes.Structure):
    _fields_ = [
        ("x", ctypes.c_float),
        ("y", ctypes.c_float),
    ]
...
class _ArkClawSpine38Vertex(ctypes.Structure):
    _fields_ = [
        ("x", ctypes.c_float),
        ("y", ctypes.c_float),
        ("u", ctypes.c_float),
...
class _ArkClawSpine38DrawView(ctypes.Structure):
    _fields_ = [
        ("vertices", ctypes.POINTER(_ArkClawSpine38Vertex)),
...
class _ArkClawSpine38EventView(ctypes.Structure):
    _fields_ = [
...
class _ArkClawSpine38TexturePageView(ctypes.Structure):
    _fields_ = [
...
class _NativeLibrary(Protocol):
    arkclaw_spine38_abi_version: _NativeFunction
    arkclaw_spine38_create: _NativeFunction
    arkclaw_spine38_destroy: _NativeFunction
    arkclaw_spine38_animation_count: _NativeFunction
    arkclaw_spine38_animation_name_size: _NativeFunction
    arkclaw_spine38_animation_info: _NativeFunction
    arkclaw_spine38_skin_count: _NativeFunction
    arkclaw_spine38_skin_name_size: _NativeFunction
    arkclaw_spine38_skin_info: _NativeFunction
    arkclaw_spine38_setup_bounds: _NativeFunction
    arkclaw_spine38_root_transform: _NativeFunction
    arkclaw_spine38_set_animation: _NativeFunction
    arkclaw_spine38_mix_animation: _NativeFunction
    arkclaw_spine38_update: _NativeFunction
    arkclaw_spine38_clear_track: _NativeFunction
    arkclaw_spine38_event_count: _NativeFunction
    arkclaw_spine38_event_view: _NativeFunction
    arkclaw_spine38_texture_page_view: _NativeFunction
    arkclaw_spine38_draw_count: _NativeFunction
    arkclaw_spine38_draw_view: _NativeFunction
...
class Spine38NativeLibrary:
    ...
    def __init__(self, library: _NativeLibrary) -> None:
        ...
        try:
            ...
            abi_version = int(cast(int, self._library.arkclaw_spine38_abi_version()))
    ...
    def create(self, snapshot: ExternalPetAssetSnapshot) -> Spine38NativePort:
        ...
        code = self._library.arkclaw_spine38_create(
            skeleton_buffer,
            skeleton_size,
            atlas_buffer,
            len(atlas),
    ...
    def _declare_signatures(self) -> None:
        ...
        library.arkclaw_spine38_abi_version.argtypes = []
        library.arkclaw_spine38_abi_version.restype = ctypes.c_uint32
        library.arkclaw_spine38_create.argtypes = [
        ...
        library.arkclaw_spine38_create.restype = ctypes.c_int
        library.arkclaw_spine38_destroy.argtypes = [ctypes.c_void_p]
        library.arkclaw_spine38_destroy.restype = None
        library.arkclaw_spine38_animation_count.argtypes = [ctypes.c_void_p]
        library.arkclaw_spine38_animation_count.restype = ctypes.c_size_t
        library.arkclaw_spine38_animation_name_size.argtypes = [
            ctypes.c_void_p,
            ctypes.c_size_t,
        ]
        library.arkclaw_spine38_animation_name_size.restype = ctypes.c_size_t
        library.arkclaw_spine38_animation_info.argtypes = [
            ctypes.c_void_p,
            ctypes.c_size_t,
            ctypes.POINTER(ctypes.c_char),
            ctypes.c_size_t,
        ...
        library.arkclaw_spine38_animation_info.restype = ctypes.c_int
        library.arkclaw_spine38_skin_count.argtypes = [ctypes.c_void_p]
        library.arkclaw_spine38_skin_count.restype = ctypes.c_size_t
        library.arkclaw_spine38_skin_name_size.argtypes = [
            ctypes.c_void_p,
            ctypes.c_size_t,
        ]
        library.arkclaw_spine38_skin_name_size.restype = ctypes.c_size_t
        library.arkclaw_spine38_skin_info.argtypes = [
            ctypes.c_void_p,
            ctypes.c_size_t,
            ctypes.POINTER(ctypes.c_char),
            ctypes.c_size_t,
        ]
        library.arkclaw_spine38_skin_info.restype = ctypes.c_int
        library.arkclaw_spine38_setup_bounds.argtypes = [
            ctypes.c_void_p,
            ctypes.POINTER(_ArkClawSpine38Bounds),
        ]
        library.arkclaw_spine38_setup_bounds.restype = ctypes.c_int
        library.arkclaw_spine38_root_transform.argtypes = [
            ctypes.c_void_p,
            ctypes.POINTER(_ArkClawSpine38RootTransform),
        ]
        library.arkclaw_spine38_root_transform.restype = ctypes.c_int
        library.arkclaw_spine38_set_animation.argtypes = [
            ctypes.c_void_p,
            ctypes.c_uint32,
            ctypes.POINTER(ctypes.c_char),
            ctypes.c_size_t,
        ...
        library.arkclaw_spine38_set_animation.restype = ctypes.c_int
        library.arkclaw_spine38_mix_animation.argtypes = [
            ctypes.c_void_p,
            ctypes.c_uint32,
            ctypes.POINTER(ctypes.c_char),
            ctypes.c_size_t,
        ...
        library.arkclaw_spine38_mix_animation.restype = ctypes.c_int
        library.arkclaw_spine38_update.argtypes = [
            ctypes.c_void_p,
            ctypes.c_float,
        ]
        library.arkclaw_spine38_update.restype = ctypes.c_int
        library.arkclaw_spine38_clear_track.argtypes = [
            ctypes.c_void_p,
            ctypes.c_uint32,
        ]
        library.arkclaw_spine38_clear_track.restype = ctypes.c_int
        library.arkclaw_spine38_event_count.argtypes = [ctypes.c_void_p]
        library.arkclaw_spine38_event_count.restype = ctypes.c_size_t
        library.arkclaw_spine38_event_view.argtypes = [
            ctypes.c_void_p,
            ctypes.c_size_t,
            ctypes.POINTER(_ArkClawSpine38EventView),
            ctypes.c_size_t,
        ]
        library.arkclaw_spine38_event_view.restype = ctypes.c_int
        library.arkclaw_spine38_texture_page_view.argtypes = [
            ctypes.c_void_p,
            ctypes.POINTER(_ArkClawSpine38TexturePageView),
            ctypes.c_size_t,
        ]
        library.arkclaw_spine38_texture_page_view.restype = ctypes.c_int
        library.arkclaw_spine38_draw_count.argtypes = [ctypes.c_void_p]
        library.arkclaw_spine38_draw_count.restype = ctypes.c_size_t
        library.arkclaw_spine38_draw_view.argtypes = [
            ctypes.c_void_p,
            ctypes.c_size_t,
            ctypes.POINTER(_ArkClawSpine38DrawView),
            ctypes.c_size_t,
        ]
        library.arkclaw_spine38_draw_view.restype = ctypes.c_int
...
class _Spine38CatalogNativeHandle:
    ...
    def __init__(
        ...
        self._finalizer = weakref.finalize(
            ...
            library.arkclaw_spine38_destroy,
            handle,
        )
    ...
    def catalog(self) -> tuple[Spine38AnimationInfo, ...]:
        with self._lock:
            ...
            count = _bounded_native_size(
                self._library.arkclaw_spine38_animation_count(handle),
                minimum=0,
    ...
    def skins(self) -> tuple[str, ...]:
        with self._lock:
            handle = self._require_open()
            count = _bounded_native_size(
                self._library.arkclaw_spine38_skin_count(handle),
                minimum=0,
                maximum=self._catalog_entry_limit,
            )
            try:
    ...
    def setup_bounds(self) -> Spine38Bounds:
        with self._lock:
            handle = self._require_open()
            raw_bounds = _ArkClawSpine38Bounds()
            _require_ok(
                self._library.arkclaw_spine38_setup_bounds(
                    handle,
    ...
    def root_transform(self) -> Spine38RootTransform:
        with self._lock:
            handle = self._require_open()
            raw_transform = _ArkClawSpine38RootTransform()
            _require_ok(
                self._library.arkclaw_spine38_root_transform(
                    handle,
                    ctypes.byref(raw_transform),
                )
            )
            values = (raw_transform.x, raw_transform.y)
            if not all(math.isfinite(value) for value in values):
                raise Spine38NativeError(Spine38NativeCode.RUNTIME_FAILURE)
            return Spine38RootTransform(*values)
    ...
    def set_animation(self, track: int, name: str, loop: bool) -> None:
        with self._lock:
            ...
            try:
                ...
                raise Spine38NativeError(Spine38NativeCode.RUNTIME_FAILURE) from None
            _require_ok(
                self._library.arkclaw_spine38_set_animation(
                    handle,
                    track,
                    name_buffer,
                    len(encoded_name),
    ...
    def mix_animation(
        ...
        with self._lock:
            handle = self._require_open()
            encoded_name = self._validated_animation_arguments(
                track,
                name,
                loop,
            )
            if isinstance(mix_seconds, bool) or not isinstance(
                mix_seconds,
                (int, float),
            ):
                raise Spine38NativeError(Spine38NativeCode.INVALID_ARGUMENT)
            narrowed_mix = ctypes.c_float(float(mix_seconds)).value
            if not math.isfinite(narrowed_mix) or narrowed_mix < 0.0:
                raise Spine38NativeError(Spine38NativeCode.INVALID_ARGUMENT)
            try:
                name_buffer = (ctypes.c_char * len(encoded_name)).from_buffer_copy(
                    encoded_name
                ...
                raise Spine38NativeError(Spine38NativeCode.RUNTIME_FAILURE) from None
            _require_ok(
                self._library.arkclaw_spine38_mix_animation(
                    handle,
                    track,
                    name_buffer,
                    len(encoded_name),
    ...
    def _validated_animation_arguments(
        self,
        track: int,
        name: str,
        loop: bool,
    ...
    def update(self, delta_seconds: float) -> None:
        with self._lock:
            ...
            if not math.isfinite(narrowed) or narrowed < 0.0:
                raise Spine38NativeError(Spine38NativeCode.INVALID_ARGUMENT)
            _require_ok(self._library.arkclaw_spine38_update(handle, narrowed))
    ...
    def clear_track(self, track: int) -> None:
        with self._lock:
            ...
            if (
                ...
                raise Spine38NativeError(Spine38NativeCode.INVALID_ARGUMENT)
            _require_ok(self._library.arkclaw_spine38_clear_track(handle, track))

    def playback_events(self) -> tuple[Spine38NativePlaybackEvent, ...]:
        with self._lock:
            handle = self._require_open()
            count = _bounded_native_size(
                self._library.arkclaw_spine38_event_count(handle),
                minimum=0,
    ...
    def draw_commands(self) -> tuple[Spine38DrawCommand, ...]:
        with self._lock:
            handle = self._require_open()
            count = _bounded_native_size(
                self._library.arkclaw_spine38_draw_count(handle),
                minimum=0,
    ...
    def texture_page_info(self) -> Spine38TexturePageInfo:
        with self._lock:
            handle = self._require_open()
            raw = _ArkClawSpine38TexturePageView()
            _require_ok(
                self._library.arkclaw_spine38_texture_page_view(
                    handle,
                    ctypes.byref(raw),
                    ctypes.sizeof(raw),
                )
    ...
    def _playback_event(
        ...
        raw = _ArkClawSpine38EventView()
        _require_ok(
            self._library.arkclaw_spine38_event_view(
                handle,
                index,
                ctypes.byref(raw),
                ctypes.sizeof(raw),
    ...
    def _animation_info(
        ...
        capacity = _bounded_native_size(
            self._library.arkclaw_spine38_animation_name_size(handle, index),
            minimum=2,
            maximum=self._catalog_name_limit,
        )
        ...
        _require_ok(
            self._library.arkclaw_spine38_animation_info(
                handle,
                index,
                name_buffer,
                capacity,
    ...
    def _skin_info(self, handle: ctypes.c_void_p, index: int) -> str:
        capacity = _bounded_native_size(
            self._library.arkclaw_spine38_skin_name_size(handle, index),
            minimum=2,
            maximum=self._catalog_name_limit,
        )
        name_buffer = _name_buffer(capacity)
        _require_ok(
            self._library.arkclaw_spine38_skin_info(
                handle,
                index,
                name_buffer,
                capacity,
    ...
    def _draw_command(
        ...
        raw_view = _ArkClawSpine38DrawView()
        _require_ok(
            self._library.arkclaw_spine38_draw_view(
                handle,
                index,
