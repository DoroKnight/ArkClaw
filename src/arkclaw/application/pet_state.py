...
STATE_ACTION_COMPATIBILITY: Mapping[
...
] = MappingProxyType(
    {
        ...
        (
            ...
            {PetActionName.DRAG_START, PetActionName.DRAG_LOOP, PetActionName.IDLE}
        ),
        (
            PetLifecycleState.ACTIVE,
            PetMotionState.FALLING,
            PetActivityState.NONE,
        ): frozenset({PetActionName.DRAG_END, PetActionName.IDLE}),
        (
            PetLifecycleState.ACTIVE,
            PetMotionState.LANDING,
            PetActivityState.NONE,
        ): frozenset({PetActionName.LANDING, PetActionName.IDLE}),
        **{
