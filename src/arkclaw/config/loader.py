...
class ConfigLoader:
    ...
    _environment_fields: ClassVar[dict[str, str]] = {
        "ARKCLAW_PROVIDER": "provider",
        "ARKCLAW_OPENAI_MODEL": "openai_model",
        "ARKCLAW_DEEPSEEK_MODEL": "deepseek_model",
        "ARKCLAW_OLLAMA_MODEL": "ollama_model",
        "ARKCLAW_PROVIDER_TIMEOUT_SECONDS": "provider_timeout_seconds",
        "ARKCLAW_MAX_TURN_SECONDS": "max_turn_seconds",
        "ARKCLAW_OPENAI_MAX_RETRIES": "openai_max_retries",
        "ARKCLAW_DEEPSEEK_MAX_RETRIES": "deepseek_max_retries",
        "ARKCLAW_OLLAMA_BASE_URL": "ollama_base_url",
        "ARKCLAW_MAX_OUTPUT_TOKENS": "max_output_tokens",
        "ARKCLAW_STREAM": "stream",
    }
    ...
    def build_parser(self) -> argparse.ArgumentParser:
        ...
        parser = _ConfigArgumentParser(
            prog="arkclaw-agent-demo",
            description="Run the ArkClaw Agent Runtime development demo.",
        )
        parser.add_argument(
            "--provider",
