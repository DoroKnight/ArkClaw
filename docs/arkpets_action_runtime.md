...
SJTUClaw now contains a pure-Python, capability-gated action sequencing layer
...
SJTUClaw's implementation is an independent Python rewrite. It does not vendor
